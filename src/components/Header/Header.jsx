...
function Header({ setSearchKeyWord ,userPlaylists}) {
        ...
        < div className="header">
            < div className="user-interface">
               ...
               <img className="user-image" src="https://cdn4.iconfinder.com/data/icons/rounded-black-basic-ui/139/Profile01-RoundedBlack-512.png"></img>
                <Link className="link-to-user" to="/layout/myplaylist">  <h2 className="user-playlist-button" >{`My playlists (${userPlaylists.length})`}</h2> </Link>
            </div>
